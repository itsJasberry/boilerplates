export default function Bridge() {
  return (
    ...
    >
      ...
      <path d="M372.5 299.5L616.5 335" stroke="#fff" />
      <path
      ...
      <path
        ...
        stroke="#fff"
      />
      <path d="M321 315V397H356.5" stroke="#fff" />
      <path
      ...
      <path
        ...
        stroke="#fff"
      />
      <path d="M214 440.5H262.5M420.5 440.5H622" stroke="#fff" />
      <path d="M404 475L427.059 474L453 475" stroke="#fff" />
      <path d="M585 454L594.882 453L606 454" stroke="#fff" />
      <path d="M543 450L552.882 449L564 450" stroke="#fff" />
      <path d="M339 511.5L379.5 508L424 511.5" stroke="#fff" />
      <path d="M339 577L393.318 573L453 577" stroke="#fff" />
      <path d="M453 703L547.818 695L652 703" stroke="#fff" />
      <path d="M460 536L505.741 533L556 536" stroke="#fff" />
      <path d="M508 467L531.347 465L557 467" stroke="#fff" />
      <path d="M315 455L338.347 453L364 455" stroke="#fff" />
      <path d="M449 453L464.247 451L481 453" stroke="#fff" />
      <path d="M252 487L275.347 484L301 487" stroke="#fff" />
      <path
      ...
      <path
        ...
        stroke="#fff"
      />
      <path d="M100.5 262L356 293M372.5 295L616 331.5" stroke="#fff" />
      <path
      ...
      <path
        ...
        stroke="#fff"
      />
      <path d="M371 87C472.6 225.4 545 303 568.5 324.5" stroke="#fff" />
      <path d="M334.5 34C339 41.1667 350 58.2 358 69" stroke="#fff" />
      <path
      ...
      <path
        ...
        stroke="#fff"
      />
      <path d="M325.5 315.5V341" stroke="#fff" />
      <path d="M325.5 360V385.5" stroke="#fff" />
      <path d="M355.5 310.5L123 283.5V270L356 297.5" stroke="#fff" />
      <path d="M372.5 311.5L616.5 344" stroke="#fff" />
      <path d="M86.5 149V222" stroke="#fff" />
      <path d="M122 137V265" stroke="#fff" />
      <path d="M155 124V268" stroke="#fff" />
      <path d="M188 109L188 273" stroke="#fff" />
      <path d="M220 93L220 276.5" stroke="#fff" />
      <path d="M251 77L251 280" stroke="#fff" />
      <path d="M281 60L281 284" stroke="#fff" />
      <path d="M391 46L391 298" stroke="#fff" />
      <path d="M417 82L417 302" stroke="#fff" />
      <path d="M441 115L441 305" stroke="#fff" />
      <path d="M465 147L465 309" stroke="#fff" />
      <path d="M488 178L488 312" stroke="#fff" />
      <path d="M511 208L511 316" stroke="#fff" />
      <path d="M532 235L532 319" stroke="#fff" />
      <path d="M553 261L553 322" stroke="#fff" />
      <path d="M571 282L571 325" stroke="#fff" />
    </svg>
  );
}
